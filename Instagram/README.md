...
- [x] AlertControllers for invalid login, invalid signup, or error while uploading pictures.

Please list two areas of the assignment you'd like to **discuss further with your peers** during the next class (examples include better ways to implement something, how to extend your app in certain ways, etc):

1. I struggled on user persistance only to realize that the code for the current user goes after code for setting up the parse server. It took quite a good bunch of my time. 
2. It took me a while understanding how to convert a post.createdAt to a nicely formatted date on the home feed.

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://github.com/membriux/iOSCodePath/blob/master/Instagram/walkthrough.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
I haven't been able to work on it as much since finals hit me hard but I will get back into it during winterbreak.
