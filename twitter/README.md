# Project 5 - *fake-twitter*

**fake-twitter** is a basic twitter app to read and compose tweets the [Twitter API](https://apps.twitter.com/).
...
1. I was struggling with the optional values and understanding the Twitter API documentation for sending POST requests for favoriting, unfavoriting, retweet, and unretweet
2. It's still a struggle understanding the power or optionals, but I've been getting it little by little.

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://github.com/membriux/iOSCodePath/blob/master/twitter/walkthrough.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes

Understandning optionals and the API documentation of a platform was the real challenge. But as I read more about it I understood it eventually. 
